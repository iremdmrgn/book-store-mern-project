...
// Erişilebilirlik ayarı: Modalın hangi elementin altında yer alacağını belirtin.
...
const ManageBooks = () => {
  ...
  // Modal state ve düzenlenecek kitabın bilgileri
  ...
  const [editingData, setEditingData] = useState({
    ...
    editionNumber: '',
    paperType: '',
    coverImage: '' // mevcut kapak resim yolu
  });

  // Yeni görsel seçimi için state
  ...
  const openModal = (book) => {
    ...
    setSelectedImage(null); // yeni görsel seçilmediyse, mevcut resim korunur.
    setModalIsOpen(true);
  };
  ...
  const handleSave = async () => {
    try {
      ...
      let response;
      // Eğer yeni görsel seçildiyse FormData kullanarak güncelleme yap
      if (selectedImage) {
